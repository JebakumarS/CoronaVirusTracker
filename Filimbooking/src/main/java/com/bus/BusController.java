...
//	Movie save process
	...
	public String viewallmovies(Model m)
	{
		m.addAttribute("movies", dao2.getAllMovies());
		return "viewallmovies";
	}
	
	@GetMapping("/movies/{id}")
	public String deletemovie(Model m,@PathVariable Long id)
	{
		m.addAttribute("movies", dao2.deletemovie(id));
...
//	Login process
	...
	public String login(@RequestParam("email") String email, @RequestParam("password") String password,
		...
		//Admin Login
		if(email.equals("ebinlalm@gmail.com")&&password.equals("12345"))
		{
			return "redirect:/AddMovie";
		}
		else
